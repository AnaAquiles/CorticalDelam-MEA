...
This repository contains all the code used in our study to [assess signal variability](https://www.biorxiv.org/content/10.1101/2025.06.16.659942v1), oscillatory patterns, and electrode behavior, offering a modular, flexible framework for brain signal exploration. This toolkit was designed to evaluate **cortical delamination** through **multi-electrode array (MEA)** signal analysis.
...
👉 You can use a [`enviroment.yml`](./enviroment.yml) or a virtual environment setup.
